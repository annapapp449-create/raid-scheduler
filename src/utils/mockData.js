...
export const mockLeader = {
  ...
  server: "泰坦重铸时光服 I",
  characters: [
    { name: "冰火魔王", classId: "mage", specId: "mage_fire" },
    { name: "黑暗游侠", classId: "hunter", specId: "hunter_marks" },
    { name: "神圣裁决", classId: "paladin", specId: "paladin_ret" },
  ],
  editPassword: "123456",
  shareId: "ABC12345",
...
export const mockSchedules = [
  ...
  },
  {
    ...
    raidSize: 25,
    characterName: "神圣裁决",
    dayOfWeek: 2, // Wednesday = Monday + 2
    startTime: "21:00",
    weekKey: "2026-W15",
    server: "泰坦重铸时光服 I",
